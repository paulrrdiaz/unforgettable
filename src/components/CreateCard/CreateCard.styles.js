...
export const Form = styled.form`
  ...
  > div + div {
    margin-left: ${({ direction = "row" }) => (direction === "row" ? ".5em" : "0")};
    margin-top: ${({ direction = "row" }) => (direction !== "row" ? ".5em" : "0")};
  }
`;
...
const input = css`
  ...
  &:focus {
    ...
    box-shadow: 0 0 12px 2px rgba(var(--blue), 0.75);
  }
`;
